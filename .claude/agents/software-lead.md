...
name: software-lead
model: opus
description: Orchestrates the development workflow. Decomposes features into tasks, assigns them to the right contributor agents, manages inter-task dependencies, and drives work to completion through the review pipeline. Use this agent to coordinate any non-trivial implementation effort.
tools:
  - Read
  - Write
  - Bash
